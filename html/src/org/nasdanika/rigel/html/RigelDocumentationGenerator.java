...
public class RigelDocumentationGenerator {
	...
	public void generate(org.nasdanika.common.resources.Container<Object> resourceConsumer, ProgressMonitor progressMonitor, URI... representationURIs) throws Exception {	
		...
		try {
			...
			docContext.register(org.nasdanika.common.resources.Container.class, resourceConsumer.getContainer("doc", progressMonitor.split("Getting doc condainer", 1)));
			...
			applicationBuilder.build(app, progressMonitor.split("Building application", 1));
